        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-12 md:gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg text-slate-300 mb-6 md:mb-8">
              Upload any PDF and get a concise summary in seconds. Our tool uses advanced AI to extract key points, saving you time and helping you understand documents faster. Perfect for students, professionals, and anyone working with large PDFs.
            </p>
